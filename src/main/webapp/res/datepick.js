...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			'Juuli', 'August', 'September', 'Oktoiber', 'November', 'Detsember'],
			...
			prevText: '&lt;Eelm', // Text for the previous month command
			prevStatus: 'Show the previous month', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: 'Näita eelmist aastat', // Status text for the previous year command
			nextText: 'Järg&gt;', // Text for the next month command
			nextStatus: 'Näita järgmist kuud', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: 'Näita järgmist aastat', // Status text for the next year command
			currentText: 'Hetke', // Text for the current month command
			currentStatus: 'Näita tänast kuud', // Status text for the current month command
			todayText: 'Täna', // Text for the today's month command
			todayStatus: 'Näita tänast kuud', // Status text for the today's month command
			clearText: 'Tühjenda', // Text for the clear command
			clearStatus: 'Tähjenda kõik kuupäevad', // Status text for the clear command
			closeText: 'Sulge', // Text for the close command
			closeStatus: 'Sulge datepicker', // Status text for the close command
			yearStatus: 'Muuda aastat', // Status text for year selection
			monthStatus: 'Muuda kuud', // Status text for month selection
			weekText: 'Nd', // Text for week of the year column header
			weekStatus: 'Nädal aastas', // Status text for week of the year column header
			dayStatus: 'Vali DD, M d, yyyy', // Status text for selectable days
			defaultStatus: 'Vali kuupäev', // Status text shown by default
