...
public class Piir {
    ...
    public static String SQL = "CREATE TABLE RIIGI_ADMIN_YKSUSE_LIIK (\n" +
            ...
            "       objekt_liik_ID       INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1),\n" +
            "       avaja                VARCHAR(32) NOT NULL,\n" +
            "       avatud               DATE NOT NULL,\n" +
            "       muutja               VARCHAR(32) NOT NULL,\n" +
            "       muudetud             DATE NOT NULL,\n" +
            ...
            "       nimetus              VARCHAR(100),\n" +
            "       kommentaar           LONGVARCHAR,\n" +
            "       objekt_ID            INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1),\n" +
            ...
            "       piiririkkuja_ID      INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 0),\n" +
            "       avaja                VARCHAR(32) NOT NULL,\n" +
            "       avatud               DATE NOT NULL,\n" +
            "       muutja               VARCHAR(32) NOT NULL,\n" +
            "       muudetud             DATE NOT NULL,\n" +
